...
namespace IDGS903_tema1.Controllers
{
    public class TrianguloController : Controller
    {
        ...
        public ActionResult DeterminarTriangulo(Triangulo tri)
        {
            ...
            double pendiente1 = triSer.CalcularPendiente(tri.X1, tri.Y1, tri.X2, tri.Y2);
            double pendiente2 = triSer.CalcularPendiente(tri.X2, tri.Y2, tri.X3, tri.Y3);
            lados[0] = lado1;
            lados[1] = lado2;
            lados[2] = lado3;
            ViewBag.TipoTriangulo = triSer.DeterminarTriangulo(lados, pendiente1, pendiente2);
